...
<body class="antialiased">
  <div
    ...
    @if (Route::has('login'))
      <div class="hidden fixed top-0 right-0 px-6 py-4 space-x-2 sm:block">
        <a href="{{ url('/threads') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">All threads</a>
      @auth
